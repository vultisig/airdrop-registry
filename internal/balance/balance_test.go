...
func TestGetUtxoBalances(t *testing.T) {
	...
	balance, err = b.FetchMayachainBalanceOfAddress("maya1h5rlf94hqkvvkyzyhmmgw0hdtw200nqjmaymqc")
	assert.Nil(t, err)
	fmt.Println("maya1h5rlf94hqkvvkyzyhmmgw0hdtw200nqjmaymqc:", balance)

	balance, err = b.FetchMayachainBalanceOfAddress("maya1vzltn37rqccwk95tny657au9j2z072dhg845dr")
	assert.Nil(t, err)
