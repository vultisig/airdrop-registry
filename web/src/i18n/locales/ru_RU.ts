...
export default {
    [translation.ADD_NEW_VAULT]: "Добавить новую хранилище",
    // B
    ...
    // G
    [translation.HINT]: "Если вы еще не сохранили QR-код, вы можете найти его в приложении в правом верхнем углу на главном экране",
    // I
    ...
    [translation.SHARE_APP]: "Поделиться приложением",
